...
with con:
    ...
    with open('../test/feature_names_1.dat', 'wb') as outfile:
    ...
    print "Finished Scaling Duration..."
    ...
    with open('../test/feature_names_2.dat', 'wb') as outfile:
    ...
    with open('../test/feature_names_3.dat', 'wb') as outfile:
    ...
    with open('../test/feature_names_4.dat', 'wb') as outfile:
    ...
    with open('../test/vectorizer_part_3.dat', 'wb') as outfile:
